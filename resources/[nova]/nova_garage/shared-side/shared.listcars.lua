listCars = {
	...
	[GetHashKey('wrm3chq')] = { model = 'wrm3chq', price = 1835000, banned = false, name = 'wrm3chq', trunk = 40, type = 'service'},
	[GetHashKey('wrr1200pm')] = { model = 'wrr1200pm', price = 1835000, banned = false, name = 'wrr1200pm', trunk = 40, type = 'service'},
	...
	[GetHashKey('wrarmoredg63')] = { model = 'wrarmoredg63', price = 3500000, banned = false, name = 'wrarmoredg63', trunk = 5, type = 'vip' },
	[GetHashKey('chernobog')] = { model = 'chernobog', price = 3500000, banned = false, name = 'chernobog', trunk = 10000, type = 'vip' },
	[GetHashKey('rallytruck2')] = { model = 'rallytruck2', price = 3500000, banned = false, name = 'rallytruck2', trunk = 3000, type = 'vip' },
	...
	[GetHashKey('3500sd')] = { model = '3500sd', price = 3500000, banned = false, name = 'BRAVADO RAM 3500 Super Duty', trunk = 150, type = 'vip' },
	[GetHashKey('f850new')] = { model = 'f850new', price = 3500000, banned = false, name = 'UBERMACHT GS F850', trunk = 20, type = 'vip' },
	...
	[GetHashKey('xc90r')] = { model = 'xc90r', price = 3500000, banned = false, name = 'VUCAR XC90r', trunk = 20, type = 'vip' },
	[GetHashKey('wrarmoredct')] = { model = 'wrarmoredct', price = 3500000, banned = false, name = 'wrarmoredct', trunk = 80, type = 'vip' },
	[GetHashKey('wrx15')] = { model = 'wrx15', price = 3500000, banned = false, name = 'wrx15', trunk = 80, type = 'vip' },
	...
	[GetHashKey('venatus')] = { model = 'venatus', price = 3500000, banned = false, name = 'PEGASSI Mansory Urus', trunk = 60, type = 'vip' },
	...
	[GetHashKey('rmodgtr50')] = { model = 'rmodgtr50', price = 1835000, banned = false, name = 'ANNIS GTR 50', trunk = 30, type = 'vip'},
	[GetHashKey('rmodmi8lb')] = { model = 'rmodmi8lb', price = 1835000, banned = false, name = 'UBERMACHT i8 conversível ', trunk = 30, type = 'vip'},
	[GetHashKey('agerars')] = { model = 'agerars', price = 1835000, banned = false, name = 'Koenisegg Agera', trunk = 30, type = 'vip'},
	[GetHashKey('rmodf12tdf')] = { model = 'rmodf12tdf', price = 1835000, banned = false, name = 'GROTTI 12 TDF', trunk = 30, type = 'vip'},
	[GetHashKey('chironss')] = { model = 'chironss', price = 1835000, banned = false, name = 'TRUFFADE Chiron', trunk = 30, type = 'vip'},
	[GetHashKey('350z')] = { model = '350z', price = 1835000, banned = false, name = 'ANNIS 350z', trunk = 40, type = 'vip'},
	[GetHashKey('rmodjeep')] = { model = 'rmodjeep', price = 1835000, banned = false, name = 'CANIS Cherokee', trunk = 600, type = 'vip'},
	[GetHashKey('audiq8')] = { model = 'audiq8', price = 1835000, banned = false, name = 'OBEY Q8', trunk = 30, type = 'vip'},
	...
	[GetHashKey('s10')] = { model = 's10', price = 1835000, banned = false, name = 'DECLASSE S10', trunk = 30, type = 'vip'},
	[GetHashKey('xreagstore')] = { model = 'xreagstore', price = 1835000, banned = false, name = 'DINKA XRE 300', trunk = 30, type = 'vip'},
	...
	[GetHashKey('WRjeep')] = { model = 'WRjeep', price = 1835000, banned = false, name = 'CANIS Grand Cherokee', trunk = 40, type = 'vip'},
	[GetHashKey('WRas350')] = { model = 'WRas350', price = 1835000, banned = false, name = 'AS350', trunk = 40, type = 'vip'},
	[GetHashKey('WRc7')] = { model = 'WRc7', price = 1835000, banned = false, name = 'INVETERO C7', trunk = 40, type = 'vip'},
	...
	[GetHashKey('wrbmwg05mgt')] = { model = 'wrbmwg05mgt', price = 1835000, banned = false, name = 'UBERMACHT 05MGT', trunk = 40, type = 'vip'},
	...
	[GetHashKey('r8spyder20')] = { model = 'r8spyder20', price = 1835000, banned = false, name = 'OBEY R8 Spyder', trunk = 30, type = 'vip'},
	[GetHashKey('moss')] = { model = 'moss', price = 1835000, banned = false, name = 'BENEFACTOR Moss', trunk = 30, type = 'vip'},
	[GetHashKey('m135i')] = { model = 'm135i', price = 1835000, banned = false, name = 'UBERMACHT M1', trunk = 30, type = 'vip'},
	[GetHashKey('sonata18')] = { model = 'sonata18', price = 1835000, banned = false, name = 'Sonata', trunk = 30, type = 'vip'},
	[GetHashKey('fordka')] = { model = 'fordka', price = 1835000, banned = false, name = 'VAPID Ka', trunk = 30, type = 'vip'},
	[GetHashKey('palio')] = { model = 'palio', price = 1835000, banned = false, name = 'Palio', trunk = 30, type = 'vip'},
	[GetHashKey('mbc')] = { model = 'mbc', price = 1835000, banned = false, name = 'BENEFACTOR Concept', trunk = 150, type = 'vip'},
	[GetHashKey('trailcat')] = { model = 'trailcat', price = 1835000, banned = false, name = 'CANIS Trailcat 4x4', trunk = 150, type = 'vip'},
	...
	[GetHashKey('mercxclass')] = { model = 'mercxclass', price = 1835000, banned = false, name = 'BENEFACTOR Class X', trunk = 150, type = 'vip'},
	...
	[GetHashKey('m2f22')] = { model = "m2f22", price = 1835000, banned = false, name = "UBERMACHT M2", trunk = 30, type = "vip" },
	[GetHashKey('eletran17')] = { model = 'eletran17', price = 1835000, banned = false, name = 'Elantra 17', trunk = 30, type = 'vip' },
	[GetHashKey('z4bmw')] = { model = 'z4bmw', price = 1835000, banned = false, name = 'UBERMACHT Z4', trunk = 30, type = 'vip' },
	[GetHashKey('punto')] = { model = 'punto', price = 1835000, banned = false, name = 'Fiat Punto', trunk = 30, type = 'vip' },
	[GetHashKey('veneno')] = { model = 'veneno', price = 1835000, banned = false, name = 'PEGASSI Veneno', trunk = 20, type = 'vip' },
	[GetHashKey('urus')] = { model = 'urus', price = 1835000, banned = false, name = 'PEGASSI Urus', trunk = 40, type = 'vip' },
	[GetHashKey('tenere1200')] = { model = 'tenere1200', price = 1835000, banned = false, name = 'NAGASAKI SUPER TENERÊ 1200', trunk = 30, type = 'vip' },
	[GetHashKey('pcx')] = { model = 'pcx', price = 1835000, banned = false, name = 'PCX 2018', trunk = 30, type = 'vip' },
	[GetHashKey('pboxstergts')] = { model = 'pboxstergts', price = 1835000, banned = false, name = 'PFISTER BOXTER 2013', trunk = 30, type = 'vip' },
	[GetHashKey('gs2013')] = { model = 'gs2013', price = 1835000, banned = false, name = 'R1200 GS 2013', trunk = 30, type = 'vip' },
	[GetHashKey('fxxkevo')] = { model = 'fxxkevo', price = 1835000, banned = false, name = 'GROTTI FXXK Evo', trunk = 30, type = 'vip' },
	[GetHashKey('fc15')] = { model = 'fc15', price = 1835000, banned = false, name = 'GROTTI California', trunk = 20, type = 'vip' },
	...
	[GetHashKey('f150')] = { model = "f150", price = 1835000, banned = false, name = 'VAPID 150', trunk = 40, type = 'vip' },
	[GetHashKey('370z')] = { model = "370z", price = 1835000, banned = false, name = 'ANNIS 370z', trunk = 40, type = 'vip' },
	[GetHashKey('a452')] = { model = "a452", price = 1835000, banned = false, name = 'BENEFACTOR A45', trunk = 40, type = 'vip' },
	...
	[GetHashKey('ftoro')] = { model = 'ftoro', price = 1835000, banned = false, name = 'VAPID Toro', trunk = 30, type = 'vip'},
	[GetHashKey('gle53')] = { model = 'gle53', price = 1835000, banned = false, name = 'BENEFACTOR GLE53', trunk = 30, type = 'vip'},
	[GetHashKey('Hilux2019')] = { model = 'Hilux2019', price = 1835000, banned = false, name = 'KARIN Hilux 2019', trunk = 30, type = 'vip'},
	[GetHashKey('huayrar')] = { model = 'huayrar', price = 1835000, banned = false, name = 'Pagani Huayra', trunk = 30, type = 'vip'},
	[GetHashKey('subwrx')] = { model = 'subwrx', price = 1835000, banned = false, name = 'KARIN WRX', trunk = 30, type = 'vip'},
	...
	[GetHashKey('675ltsp')] = { model = '675ltsp ', price = 1835000, banned = false, name = 'PROGEN 675 LT SP', trunk = 30, type = 'vip'},
	[GetHashKey('wladlc500')] = { model = 'wladlc500', price = 1835000, banned = false, name = 'EMPEROR LC 500', trunk = 30, type = 'vip'},
	[GetHashKey('rs520')] = { model = 'rs520', price = 1835000, banned = false, name = 'OBEY RS5 2020', trunk = 30, type = 'vip'},
	[GetHashKey('amgone')] = { model = 'amgone', price = 1835000, banned = false, name = 'BENEFACTOR AMG ONE', trunk = 30, type = 'vip'},
	[GetHashKey('sjdodge')] = { model = 'sjdodge', price = 1835000, banned = false, name = 'BRAVADO Charger Hellcat', trunk = 30, type = 'vip'},
	[GetHashKey('bmwg07')] = { model = 'bmwg07', price = 1835000, banned = false, name = 'UBERMACHT X7 2021', trunk = 30, type = 'vip'},
	[GetHashKey('c8z0623')] = { model = 'c8z0623', price = 1835000, banned = false, name = 'INVETERO C7 2023', trunk = 30, type = 'vip'},
	[GetHashKey('dd911gtrsr')] = { model = 'dd911gtrsr', price = 1835000, banned = false, name = 'PFISTER 911R GT2 DD', trunk = 30, type = 'vip'},
	[GetHashKey('lpi8004')] = { model = 'lpi8004 ', price = 1835000, banned = false, name = 'PEGASSI Countach LPI800-4', trunk = 30, type = 'vip'},
	...
	[GetHashKey('fnflan')] = { model = 'fnflan', price = 1835000, banned = false, name = 'MAIBATSU Lancer Evolution IX GSR', trunk = 30, type = 'vip'},
	[GetHashKey('ff4wrx')] = { model = 'ff4wrx', price = 1835000, banned = false, name = 'KARIN Impreza Fast and Furious', trunk = 30, type = 'vip'},
	[GetHashKey('2f2fmk4')] = { model = '2f2fmk4', price = 1835000, banned = false, name = 'KARIN Supra Fast and Furious', trunk = 30, type = 'vip'},
	[GetHashKey('fnfmk4')] = { model = 'fnfmk4', price = 1835000, banned = false, name = 'KARIN Supra Fast and Furious 2', trunk = 30, type = 'vip'},
	[GetHashKey('fnfmits')] = { model = 'fnfmits', price = 1835000, banned = false, name = 'MAIBATSU Eclipse do Brian', trunk = 30, type = 'vip'},
	...
	[GetHashKey('2f2fgts')] = { model = '2f2fgts', price = 1835000, banned = false, name = 'MAIBATSU Spyder do Roman', trunk = 30, type = 'vip'},
	...
	[GetHashKey('fc15')] = { model = 'fc15', price = 1835000, banned = false, name = 'GROTTI California', trunk = 30, type = 'vip'},
	[GetHashKey('ttrs')] = { model = 'ttrs', price = 1835000, banned = false, name = 'OBEY TTrs', trunk = 30, type = 'vip'},
	...
	[GetHashKey('WRx6')] = { model = "WRx6", price = 1000000, banned = false, name = "UBERMACHT x6", trunk = 30, type = "service" },
	...
	[GetHashKey('WRBmwm8')] = { model = "WRBmwm8", price = 1000000, banned = false, name = "UBERMACHT m8", trunk = 30, type = "service" },
	[GetHashKey('WRBmwm1')] = { model = "WRBmwm1", price = 1000000, banned = false, name = "UBERMACHT m1", trunk = 30, type = "service" },
	[GetHashKey('WRbmwi8')] = { model = "WRbmwi8", price = 1000000, banned = false, name = "UBERMACHT i8", trunk = 30, type = "service" },
	[GetHashKey('WRbmwm4')] = { model = "WRbmwm4", price = 1000000, banned = false, name = "UBERMACHT M4 Policia", trunk = 30, type = "service" },
	...
	[GetHashKey('dodgeems')] = { model = "dodgeems", price = 1000000, banned = false, name = "BRAVADO EMS", trunk = 30, type = "service" },
	
	--[[VEÍCULOS VIP]]--
	[GetHashKey('rmodlegosenna')] = { model = 'rmodlegosenna', price = 1835000, banned = false, name = 'PROGEN Lego Senna ', trunk = 30, type = 'vip'},
	[GetHashKey('foxc8')] = { model = 'foxc8', price = 1835000, banned = false, name = 'INVETERO C8 ', trunk = 30, type = 'vip'},
	[GetHashKey('m3e46')] = { model = 'm3e46', price = 1835000, banned = false, name = 'UBERMACHT M3 E46', trunk = 30, type = 'vip'},
	[GetHashKey('rmodcharger69')] = { model = 'rmodcharger69', price = 1835000, banned = false, name = 'BRAVADO Charger', trunk = 30, type = 'vip'},
	...
	[GetHashKey('rmodessenza')] = { model = 'rmodessenza', price = 1835000, banned = false, name = 'PEGASSI Essenza', trunk = 30, type = 'vip' },
	[GetHashKey('adr8')] = { model = 'adr8', price = 1835000, banned = false, name = 'OBEY R8 2021', trunk = 30, type = 'vip' },
	...
	[GetHashKey('r1')] = { model = 'r1', price = 1835000, banned = false, name = 'NAGASAKI R1', trunk = 50, type = 'vip' },
	[GetHashKey('s1000rr')] = { model = 's1000rr', price = 1835000, banned = false, name = 'UBERMACHT S1000RR', trunk = 30, type = 'vip' },
	[GetHashKey('pcj')] = { model = 'pcj', price = 1835000, banned = false, name = 'KTM', trunk = 5, type = 'vip' },
	[GetHashKey('audirs7')] = { model = 'audirs7', price = 1835000, banned = false, name = 'OBEY RS7', trunk = 40, type = 'vip' },
	[GetHashKey('718b')] = { model = '718b', price = 1835000, banned = false, name = 'PFISTER 718B', trunk = 40, type = 'vip' },
	[GetHashKey('ferrariitalia')] = { model = 'ferrariitalia', price = 1835000, banned = false, name = 'GROTTI Itália', trunk = 40, type = 'vip' },
	[GetHashKey('fordmustang')] = { model = 'fordmustang', price = 1835000, banned = false, name = 'VAPID Mustang', trunk = 40, type = 'vip' },
	[GetHashKey('lancerevolutionx')] = { model = 'lancerevolutionx', price = 1835000, banned = false, name = 'Lancer Evolution X', trunk = 40, type = 'vip' },
	[GetHashKey('teslaprior')] = { model = 'teslaprior', price = 1835000, banned = false, name = 'COIL Prior', trunk = 40, type = 'vip' },
	[GetHashKey('bmws')] = { model = 'bmws', price = 1835000, banned = false, name = 'UBERMACHT S', trunk = 40, type = 'vip' },
	[GetHashKey('panigale')] = { model = 'panigale', price = 1835000, banned = false, name = 'Ducati', trunk = 40, type = 'vip' },
	[GetHashKey('gsxr')] = { model = 'gsxr', price = 1835000, banned = false, name = 'SHITZU GSXR', trunk = 40, type = 'vip' },
	[GetHashKey('hayabusa')] = { model = 'hayabusa', price = 1835000, banned = false, name = 'Hayabusa', trunk = 40, type = 'vip' },
	[GetHashKey('r6')] = { model = 'r6', price = 1835000, banned = false, name = 'NAGASAKI R6', trunk = 40, type = 'vip' },
	...
	[GetHashKey('z1000')] = { model = 'z1000', price = 65000, banned = false, name = 'Z1000', trunk = 40, type = 'vip' },
	...
	[GetHashKey('rmodbentleygt')] = { model = 'rmodbentleygt', price = 1835000, banned = false, name = 'ENUS GT', trunk = 40, type = 'vip' },
	[GetHashKey('rmodbmwm8')] = { model = 'rmodbmwm8', price = 1835000, banned = false, name = 'UBERMACHT M8', trunk = 40, type = 'vip' },
	[GetHashKey('africat')] = { model = 'africat', price = 1835000, banned = false, name = 'Africat', trunk = 40, type = 'vip' },
	[GetHashKey('c7')] = { model = 'c7', price = 1835000, banned = false, name = 'INVETERO Conversivel 7', trunk = 40, type = 'vip' },
	[GetHashKey('cx75')] = { model = 'cx75', price = 1835000, banned = false, name = 'OCELOT C-X75', trunk = 40, type = 'vip' },
	[GetHashKey('divo')] = { model = 'divo', price = 1835000, banned = false, name = 'TRUFFADE Divo', trunk = 40, type = 'vip' },
	[GetHashKey('evoque')] = { model = 'evoque', price = 1835000, banned = false, name = 'Range Rover Evoque', trunk = 40, type = 'vip' },
	[GetHashKey('f8t')] = { model = 'f8t', price = 1835000, banned = false, name = 'GROTTI Pista 8', trunk = 40, type = 'vip' },
	[GetHashKey('fz07')] = { model = 'fz07', price = 1835000, banned = false, name = 'NAGASAKI FZ-07', trunk = 40, type = 'vip' },
	[GetHashKey('nh2r')] = { model = 'nh2r', price = 1835000, banned = false, name = 'NAGASAKI Ninja H2R', trunk = 40, type = 'vip' },
	[GetHashKey('pamodelra17turbo')] = { model = 'pamodelra17turbo', price = 1835000, banned = false, name = 'PFISTER Pamodelra 17 TURBO', trunk = 40, type = 'vip' },
	[GetHashKey('r1200')] = { model = 'r1200', price = 1835000, banned = false, name = 'UBERMACHT R1250', trunk = 40, type = 'vip' },
	[GetHashKey('terzo')] = { model = 'terzo', price = 1835000, banned = false, name = 'PEGASSI Terzo', trunk = 40, type = 'vip' },
	...
	[GetHashKey('18performante')] = { model = '18performante', price = 1835000, banned = false, name = 'PEGASSI Huracan NOVA', trunk = 40, type = 'vip' },
	[GetHashKey('bmwi8')] = { model = 'bmwi8', price = 1835000, banned = false, name = 'UBERMACHT I8', trunk = 40, type = 'vip' },
	[GetHashKey('silvias15')] = { model = 'silvias15', price = 1835000, banned = false, name = 'ANNIS Silvia S15', trunk = 50, type = 'vip' },
	...
	[GetHashKey('d99')] = { model = 'd99', price = 1835000, banned = false, name = 'PEGASSI 1199 Panigale', trunk = 50, type = 'vip' },
	[GetHashKey('elva')] = { model = 'elva', price = 1835000, banned = false, name = 'Elva', trunk = 40, type = 'vip' },
	[GetHashKey('foxct')] = { model = 'foxct', price = 1835000, banned = false, name = 'COIL CyberTruck', trunk = 40, type = 'vip' },
	[GetHashKey('foxevo')] = { model = 'foxevo', price = 1835000, banned = false, name = 'PEGASSI Evo', trunk = 40, type = 'vip' },
	[GetHashKey('foxgt2')] = { model = 'foxgt2', price = 1835000, banned = false, name = 'PROGEN GT2', trunk = 40, type = 'vip' },
	[GetHashKey('foxsenna')] = { model = 'foxsenna', price = 1835000, banned = false, name = 'PROGEN Senna', trunk = 40, type = 'vip' },
	...
	[GetHashKey('rmodgt63')] = { model = 'rmodgt63', price = 1835000, banned = false, name = 'BENEFACTOR GT63', trunk = 40, type = 'vip' },
	[GetHashKey('lwgtr')] = { model = 'lwgtr', price = 1835000, banned = false, name = 'LWGTR', trunk = 40, type = 'vip' },
	[GetHashKey('huracangt3evo')] = { model = 'huracangt3evo', price = 1835000, banned = false, name = 'PEGASSI Huracan GT3 EVO', trunk = 40, type = 'vip' },
	[GetHashKey('l200')] = { model = 'l200', price = 1835000, banned = false, name = 'L200', trunk = 40, type = 'vip' },
	[GetHashKey('bmwm4gts')] = { model = 'bmwm4gts', price = 1835000, banned = false, name = 'UBERMACHT M4GTS', trunk = 40, type = 'vip' },
	...
	[GetHashKey('pistaspider19')] = { model = 'pistaspider19', price = 1835000, banned = false, name = 'GROTTI Spider', trunk = 40, type = 'vip' },
	...
	[GetHashKey('a80')] = { model = 'a80', price = 1835000, banned = false, name = 'KARIN Supra', trunk = 40, type = 'vip' },
	...
	[GetHashKey('rmodx6')] = { model = 'rmodx6', price = 1835000, banned = false, name = 'UBERMACHT X6', trunk = 40, type = 'vip' },
	[GetHashKey('918S')] = { model = '918S', price = 1835000, banned = false, name = 'PFISTER Spyder', trunk = 30, type = 'vip' },
	...
	[GetHashKey('rmodsianr')] = { model = 'rmodsianr', price = 1835000, banned = false, name = 'PEGASSI Sian', trunk = 30, type = 'vip' },
	...
	[GetHashKey('minittrs')] = { model = 'minittrs', price = 1835000, banned = false, name = 'OBEY TRS KID', trunk = 10, type = 'vip'},
	...
	[GetHashKey('etrongt22')] = { model = "etrongt22", price = 3000000, banned = false, name = 'OBEY E-TRON', trunk = 40, type = 'vip' },
	[GetHashKey('23s63l')] = { model = "23s63l", price = 3000000, banned = false, name = 'S63 Luxury', trunk = 40, type = 'vip' },
	[GetHashKey('xplaid24c')] = { model = "xplaid24c", price = 3000000, banned = false, name = 'COIL Model X', trunk = 40, type = 'vip' },
	[GetHashKey('noire19wb')] = { model = "noire19wb", price = 2000000, banned = false, name = 'TRUFFADE La Voiture Noire', trunk = 40, type = 'vip' },
	[GetHashKey('x7m60i')] = { model = "x7m60i", price = 3000000, banned = false, name = 'UBERMACHT X7 2024', trunk = 40, type = 'vip' },
	[GetHashKey('m3g80c')] = { model = "m3g80c", price = 3000000, banned = false, name = 'UBERMACHT M3 G80 Competition', trunk = 40, type = 'vip' },
	[GetHashKey('lexuslfa')] = { model = "lexuslfa", price = 3000000, banned = false, name = 'EMPEROR LFA', trunk = 40, type = 'vip' },
	...
	[GetHashKey('paramedicocharger2014')] = { model = 'paramedicocharger2014', price = 1000000, banned = false, name = 'BRAVADO Charger 2014', trunk = 0, type = 'service' },
	...
	[GetHashKey('nissangtr')] = { model = 'nissangtr', price = 3000000, banned = false, name = 'ANNIS GTR', trunk = 100, type = 'vip' },
	[GetHashKey('weevil')] = { model = 'weevil', price = 150000, banned = false, name = 'Fusca', trunk = 150, type = 'vip' },
	[GetHashKey('nissan370z')] = { model = 'nissan370z', price = 1000000, banned = false, name = 'ANNIS 370Z', trunk = 40, type = 'vip' },
	[GetHashKey('dodgechargersrt')] = { model = 'dodgechargersrt', price = 2000000, banned = false, name = 'BRAVADO Charger SRT', trunk = 50, type = 'import' },
	[GetHashKey('14r8')] = { model = '14r8', price = 1000000, banned = false, name = 'OBEY R8 2014', trunk = 30, type = 'vip' },
	[GetHashKey('bmwm3f80')] = { model = 'bmwm3f80', price = 1350000, banned = false, name = 'UBERMACHT M3 F80', trunk = 50, type = 'import' },
	[GetHashKey('nissangtrnismo')] = { model = 'nissangtrnismo', price = 2900000, banned = false, name = 'ANNIS GTR Nismo', trunk = 40, type = 'vip' },
	...
	[GetHashKey('mercedesa45')] = { model = 'mercedesa45', price = 1200000, banned = false, name = 'BENEFACTOR A45', trunk = 40, type = 'import' },
	...
	[GetHashKey('p1')] = { model = 'p1', price = 1000000, banned = false, name = 'PROGEN P1', trunk = 20, type = 'vip' },
	[GetHashKey('i8')] = { model = 'i8', price = 1000000, banned = false, name = 'UBERMACHT i8', trunk = 35, type = 'vip' },
	[GetHashKey('bme6tun')] = { model = 'bme6tun', price = 1000000, banned = false, name = 'UBERMACHT M5', trunk = 50, type = 'vip' },
	...
	[GetHashKey('senna')] = { model = 'senna', price = 1000000, banned = false, name = 'PROGEN Senna', trunk = 20, type = 'vip' },
	[GetHashKey('bnteam')] = { model = 'bnteam', price = 1000000, banned = false, name = 'Bentley', trunk = 20, type = 'vip' },
	[GetHashKey('rmodlp770')] = { model = 'rmodlp770', price = 1000000, banned = false, name = 'PEGASSI Centenario', trunk = 20, type = 'vip' },
	[GetHashKey('s15')] = { model = 's15', price = 1000000, banned = false, name = 'ANNIS Silvia S15', trunk = 20, type = 'vip' },
	[GetHashKey('amggtr')] = { model = 'amggtr', price = 1000000, banned = false, name = 'BENEFACTOR AMG', trunk = 20, type = 'vip' },
	[GetHashKey('lamtmc')] = { model = 'lamtmc', price = 1000000, banned = false, name = 'PEGASSI Terzo', trunk = 20, type = 'vip' },
	[GetHashKey('vantage')] = { model = 'vantage', price = 1000000, banned = false, name = 'DEWBAUCHEE Vantage', trunk = 20, type = 'vip' },
	[GetHashKey('slsamg')] = { model = 'slsamg', price = 1000000, banned = false, name = 'BENEFACTOR SLS', trunk = 20, type = 'vip' },
	[GetHashKey('g65amg')] = { model = 'g65amg', price = 1000000, banned = false, name = 'BENEFACTOR G65', trunk = 0, type = 'vip' },
	...
	[GetHashKey('rmodamgc63')] = { model = 'rmodamgc63', price = 1000000, banned = false, name = 'BENEFACTOR AMG C63', trunk = 40, type = 'vip' },
	[GetHashKey('palameila')] = { model = 'palameila', price = 1000000, banned = false, name = 'PFISTER Pamodelra', trunk = 50, type = 'vip' },
	[GetHashKey('cb500x')] = { model = 'cb500x', price = 1000000, banned = false, name = 'DINKA CB500', trunk = 15, type = 'vip' },
	[GetHashKey('rsvr16')] = { model = 'rsvr16', price = 1000000, banned = false, name = 'Ranger Rover', trunk = 50, type = 'vip' },
	[GetHashKey('19ramdonk')] = { model = '19ramdonk', price = 1000000, banned = false, name = 'BRAVADO Ram Donk', trunk = 80, type = 'vip' },
	...
	[GetHashKey('bbentayga')] = { model = 'bbentayga', price = 1000000, banned = false, name = 'ENUS Bentayga', trunk = 50, type = 'vip' },
	[GetHashKey('nissantitan17')] = { model = 'nissantitan17', price = 1000000, banned = false, name = 'ANNIS Titan 2017', trunk = 120, type = 'vip' },
	[GetHashKey('regera')] = { model = 'regera', price = 1000000, banned = false, name = 'OVERFLOD Regera', trunk = 20, type = 'vip' },
	[GetHashKey('msohs')] = { model = 'msohs', price = 1000000, banned = false, name = 'PROGEN 688 HS', trunk = 20, type = 'vip' },
	[GetHashKey('gt17')] = { model = 'gt17', price = 1000000, banned = false, name = 'VAPID GT 17', trunk = 20, type = 'vip' },
	[GetHashKey('19ftype')] = { model = '19ftype', price = 1000000, banned = false, name = 'OCELOT F-Type', trunk = 50, type = 'vip' },
	[GetHashKey('488gtb')] = { model = '488gtb', price = 1000000, banned = false, name = 'GROTTI 488 GTB', trunk = 30, type = 'vip' },
	[GetHashKey('m2')] = { model = 'm2', price = 1000000, banned = false, name = 'UBERMACHT M2', trunk = 50, type = 'vip' },
	[GetHashKey('defiant')] = { model = 'defiant', price = 1000000, banned = false, name = 'AMC Javelin 72', trunk = 40, type = 'vip' },
	[GetHashKey('f12tdf')] = { model = 'f12tdf', price = 1000000, banned = false, name = 'GROTTI F12 TDF', trunk = 20, type = 'vip' },
	[GetHashKey('71gtx')] = { model = '71gtx', price = 1000000, banned = false, name = 'Plymouth 71 GTX', trunk = 50, type = 'vip' },
	[GetHashKey('porsche992')] = { model = 'porsche992', price = 1000000, banned = false, name = 'PFISTER 992', trunk = 20, type = 'vip' },
	[GetHashKey('18macan')] = { model = '18macan', price = 1000000, banned = false, name = 'PFISTER Macan', trunk = 60, type = 'vip' },
	[GetHashKey('m6e63')] = { model = 'm6e63', price = 1000000, banned = false, name = 'UBERMACHT M6 E63', trunk = 50, type = 'vip' },
	[GetHashKey('180sx')] = { model = '180sx', price = 1000000, banned = false, name = 'ANNIS 180SX', trunk = 10, type = 'vip' },
	[GetHashKey('hondafk8')] = { model = 'hondafk8', price = 1700000, banned = false, name = 'DINKA FK8', trunk = 40, type = 'import' },
	[GetHashKey('mustangmach1')] = { model = 'mustangmach1', price = 1100000, banned = false, name = 'Mustang Mach 1', trunk = 40, type = 'import' },
	[GetHashKey('porsche930')] = { model = 'porsche930', price = 1300000, banned = false, name = 'PFISTER 930', trunk = 20, type = 'import' },
	[GetHashKey('raptor2017')] = { model = 'raptor2017', price = 2000000, banned = false, name = 'VAPID Raptor 2017', trunk = 150, type = 'vip' },
	[GetHashKey('filthynsx')] = { model = 'filthynsx', price = 1000000, banned = false, name = 'DINKA NSX', trunk = 20, type = 'vip' },
	[GetHashKey('2018zl1')] = { model = '2018zl1', price = 1000000, banned = false, name = 'Camaro ZL1', trunk = 40, type = 'vip' },
	[GetHashKey('eclipse')] = { model = 'eclipse', price = 1000000, banned = false, name = 'MAIBATSU Eclipse', trunk = 30, type = 'vip' },
	[GetHashKey('lp700r')] = { model = 'lp700r', price = 1000000, banned = false, name = 'PEGASSI LP700R', trunk = 0, type = 'vip' },
	[GetHashKey('db11')] = { model = 'db11', price = 1000000, banned = false, name = 'DEWBAUCHEE DB11', trunk = 0, type = 'vip' },
	...
	[GetHashKey('pistas')] = { model = 'pistas', price = 1000000, banned = false, name = 'GROTTI Pista', trunk = 30, type = 'vip' },
	[GetHashKey('yzfr125')] = { model = 'yzfr125', price = 1000000, banned = false, name = 'NAGASAKI YZF R125', trunk = 10, type = 'vip' },
	[GetHashKey('mt03')] = { model = 'mt03', price = 1000000, banned = false, name = 'NAGASAKI MT 03', trunk = 10, type = 'vip' },
	[GetHashKey('flatbed3')] = { model = 'flatbed3', price = 1000000, banned = false, name = 'flatbed3', trunk = 0, type = 'service' },
	[GetHashKey('20r1')] = { model = '20r1', price = 1000000, banned = false, name = 'NAGASAKI YZF R1', trunk = 10, type = 'vip' },
	[GetHashKey('SVR14')] = { model = 'SVR14', price = 1000000, banned = false, name = 'Ranger Rover', trunk = 50, type = 'vip' },
	[GetHashKey('Bimota')] = { model = 'Bimota', price = 1000000, banned = false, name = 'PEGASSI Bimota', trunk = 10, type = 'vip' },
	[GetHashKey('r8ppi')] = { model = 'r8ppi', price = 1000000, banned = false, name = 'OBEY R8 PPI Razor', trunk = 30, type = 'vip' },
	...
	[GetHashKey('911tbs')] = { model = '911tbs', price = 1000000, banned = false, name = 'PFISTER 911S', trunk = 25, type = 'vip' },
	...
	[GetHashKey('zx10r')] = { model = 'zx10r', price = 1000000, banned = false, name = 'NAGASAKI ZX10R', trunk = 20, type = 'vip' },
	[GetHashKey('fox600lt')] = { model = 'fox600lt', price = 1000000, banned = false, name = 'PROGEN 600LT', trunk = 40, type = 'vip' },
	[GetHashKey('foxbent1')] = { model = 'foxbent1', price = 1000000, banned = false, name = 'ENUS Liter 1931', trunk = 40, type = 'vip' },
	[GetHashKey('jeepg')] = { model = 'jeepg', price = 1000000, banned = false, name = 'CANIS Gladiator', trunk = 90, type = 'vip' },
	...
	[GetHashKey('foxleggera')] = { model = 'foxleggera', price = 1000000, banned = false, name = 'DEWBAUCHEE Leggera', trunk = 50, type = 'vip' },
	[GetHashKey('foxrossa')] = { model = 'foxrossa', price = 1000000, banned = false, name = 'GROTTI Rossa', trunk = 40, type = 'vip' },
	[GetHashKey('foxshelby')] = { model = 'foxshelby', price = 1000000, banned = false, name = 'VAPID Shelby GT500', trunk = 40, type = 'vip' },
	[GetHashKey('foxsian')] = { model = 'foxsian', price = 1000000, banned = false, name = 'PEGASSI Sian', trunk = 40, type = 'vip' },
	[GetHashKey('foxsterrato')] = { model = 'foxsterrato', price = 1000000, banned = false, name = 'PEGASSI Sterrato', trunk = 40, type = 'vip' },
	[GetHashKey('foxsupra')] = { model = 'foxsupra', price = 1000000, banned = false, name = 'KARIN Supra', trunk = 50, type = 'vip' },
	[GetHashKey('m6x6')] = { model = 'm6x6', price = 1000000, banned = false, name = 'BENEFACTOR Benz 6x6', trunk = 90, type = 'vip' },
	[GetHashKey('m6gt3')] = { model = 'm6gt3', price = 1000000, banned = false, name = 'UBERMACHT M6 GT3', trunk = 40, type = 'vip' },
	...
	[GetHashKey('xplaid24c')] = { model = 'xplaid24c', price = 1000000, banned = false, name = 'COIL Model X', trunk = 30, type = 'vip' },
	[GetHashKey('amrevu23mg')] = { model = 'amrevu23mg', price = 1000000, banned = false, name = 'PEGASSI Revuelto', trunk = 30, type = 'vip' },
	...
	[GetHashKey('mclarensenna')] = { model = 'mclarensenna', price = 1000000, banned = false, name = 'PROGEN Senna', trunk = 50, type = 'vip' },
	[GetHashKey('gt3marlboro')] = { model = 'gt3marlboro', price = 1000000, banned = false, name = 'GT3 Marlboro', trunk = 50, type = 'vip' },
	[GetHashKey('mclaren')] = { model = 'mclaren', price = 1000000, banned = false, name = 'PROGEN MP4/4', trunk = 50, type = 'vip' },

	[GetHashKey('q6audi23')] = { model = 'q6audi23', price = 1000000, banned = false, name = 'OBEY Q6', trunk = 80, type = 'vip' },
	...
	[GetHashKey('sl63')] = { model = 'sl63', price = 1000000, banned = false, name = 'BENEFACTOR SL63', trunk = 40, type = 'vip' },
	...
	[GetHashKey('720wb')] = { model = '720wb', price = 1000000, banned = false, name = 'PROGEN 720S WB', trunk = 30, type = 'vip' },
	...
	[GetHashKey('wrarmoredpurosangue')] = { model = 'wrarmoredpurosangue', price = 1000000, banned = false, name = 'GROTTI Purosangue', trunk = 60, type = 'vip' },
	[GetHashKey('F40LBWK')] = { model = 'F40LBWK', price = 1000000, banned = false, name = 'GROTTI SF90', trunk = 60, type = 'vip' },
	...
	[GetHashKey('chironss22')] = { model = 'chironss22', price = 1000000, banned = false, name = 'Chiron SS', trunk = 30, type = 'vip' },
	[GetHashKey('mbc')] = { model = 'mbc', price = 1000000, banned = false, name = 'BENEFACTOR MBC', trunk = 30, type = 'vip' },
}